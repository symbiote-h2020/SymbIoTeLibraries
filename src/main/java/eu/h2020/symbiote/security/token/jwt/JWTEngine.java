...
public class JWTEngine {
    ...
    private void validateToken(SymbIoTeToken token, PublicKey publicKey) throws TokenValidationException
    {
        try {
    ...
    public JWTClaims getClaimsFromToken(String jwtToken) throws MalformedJWTException {
        ...
        try {
            ...
            Iterator<String> iter = jwtKeys.iterator();
            while (iter.hasNext()) {
