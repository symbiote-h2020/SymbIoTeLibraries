...
public class Location extends AbstractLocation {
    ...
    public boolean equals(Object other) {
    	...
    	if (!Objects.equals(this.id, ol.id))
    		return false;
    	
    	if (!Objects.equals(this.name, ol.name))
    		return false;
...
//    	if (!Objects.equals(this.comment, ol.comment))
//    		return false;
    	
//    	if (!Objects.equals(this.description, ol.description))
//    		return false;
	...
	public int hashCode() {
    	...
    	result+=Objects.hashCode(this.id)*3;
    	result+=Objects.hashCode(this.name)*5;
