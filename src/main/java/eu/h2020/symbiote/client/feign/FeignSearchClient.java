...
import static eu.h2020.symbiote.client.AbstractSymbIoTeClientFactory.CORE_AAM_SUBPATH;
...
public class FeignSearchClient implements SearchClient {
    ...
    private static final String SEARCH_BASE_URL = CORE_AAM_SUBPATH + "/query";
